...
- **Flexibilidad para evolución del sistema**: Se busca que el sistema pueda integrar nuevos métodos de autenticación sin necesidad de modificar el código existente de otros métodos.
