...
## ADR 1: Elección entre Lenguaje Tipado vs No Tipado para todo el proyecto
...
## ADR 2: Elección entre base de datos relacional vs no relacional para el almacenamiento principal de los datos
...
## ADR 3: Elección entre Next.js vs Angular para el frontend
...
## ADR 4: Elección entre Express.js vs NestJS para el backend
...
## ADR 5: Elección entre AWS vs Azure como proveedor de nube
