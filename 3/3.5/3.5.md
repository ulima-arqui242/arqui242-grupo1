...
**Criterios de Elección**:  
   - **Robustez y Seguridad:** Reducir al mínimo los errores en producción, especialmente al manejar datos médicos sensibles.
   - **Mantenibilidad:** El sistema debe poder escalar sin que el código se vuelva difícil de gestionar o corregir.
   - **Experiencia del Equipo:** Asegurar que el equipo pueda trabajar de forma eficiente sin una curva de aprendizaje demasiado pronunciada.
