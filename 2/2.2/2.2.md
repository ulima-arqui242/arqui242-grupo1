...
| **Atributo de Calidad** | **Estímulo** | **Fuente del Estímulo** | **Artefacto** | **Entorno** | **Respuesta** | **Medida de Respuestas** |
| ----------------------- | ------------ | ----------------------- | ------------- | ----------- | ------------- | ------------------------ |
| Disponibilidad | Solicitud de muchos pacientes para teleconsulta| Pacientes| Módulo de teleconsulta| Alta demanda de brote| aumentar la disponibilidad de los doctores| Doctores deben tener disponibilidad inmediata |
| Disponibilidad | Fallo de la videollamada de teleconsulta| Conexión a internet del paciente, médico o clínica| Módulo de teleconsulta| Problemas de internet| Buena conexión a internet en la clínica y los médicos deben tener buena conexión en sus casas| Disponibilidad de internet el 99.9 porciento del tiempo |
