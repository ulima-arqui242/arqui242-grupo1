...
- **RF1** Como usuario (paciente o médico), quiero poder iniciar y mantener conversaciones con un médico o paciente para intercambiar información relevante sobre mi atención médica.
- **RF2** Como usuario (paciente o médico), quiero ver una lista de todas las conversaciones previas para poder hacer seguimiento y continuar la atención de manera fluida.
- **RF3** Como usuario (paciente o médico), quiero recibir notificaciones por correo electrónico o SMS cuando reciba un nuevo mensaje en el chat para estar al tanto de las actualizaciones y responder a tiempo.
